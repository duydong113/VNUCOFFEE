...
if(isset($_POST['update'])){
   ...
   $update_product = $conn->prepare("UPDATE `product` SET Name = ?, CategoryID = ?, Price = ? WHERE ProductID = ?");
...
<section class="update-product">
   ...
   <?php
      ...
      $show_products = $conn->prepare("SELECT * FROM `product` WHERE ProductID = ?");
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         <option selected value="<?= $fetch_products['CategoryID']; ?>"><?= $fetch_products['CategoryID']; ?></option>
