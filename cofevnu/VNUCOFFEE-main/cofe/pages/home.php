...
<div class="signature-section" style="display: flex; align-items: center; justify-content: center; background: #fff; margin: 40px 0; padding: 40px 0;">
  <div style="flex: 1; max-width: 500px; padding: 40px;">
    ...
    <h3 style="font-size: 2em; color: #222; margin-bottom: 20px;">By The VNUISCOFFEEShop</h3>
   ...
   <a href="../pages/about.php">
    <button style="background: #c00; color: #fff; border: none; padding: 15px 40px; border-radius: 8px; font-size: 1.1em; font-weight: bold; cursor: pointer;">
        Find out more
    </button>
</a>
